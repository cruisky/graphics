...
namespace TX
{
	namespace SSE
	{
		...
		__forceinline const V4Bool Shuffle(const V4Bool& a){ return _mm_shuffle_epi32(a, _MM_SHUFFLE(v3, v2, v1, v0)); }
		template<size_t a0, size_t a1, size_t b2, size_t b3>
		__forceinline const V4Bool Shuffle(const V4Bool& a, const V4Bool& b){ return _mm_castps_si128(_mm_shuffle_ps(_mm_castsi128_ps(a), _mm_castsi128_ps(b), _MM_SHUFFLE(b3, b2, a1, a0))); }
